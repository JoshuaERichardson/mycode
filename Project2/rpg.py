...
bestiary = [
    {"name": "goblin", "health": 10, "damage": "1d5"},
...
def showStatus():  # display the player's status
    ...
    if "spell" in rooms[currentRoom]:
        print(
            'You see a magic scroll. On the ribbon it says "'
...
def spellreceive(incantation):
    ...
    print(
        "The spell has been successfully added to your spellbook. Be careful... magic is dangerous!"
    )
...
rooms = {
    ...
    "PANTRY": {
        ...
        "randenc": "0",
        "item": "cookie",
        "item_status": " hiding behind a bag of carrots.  Chad must have been hiding these for later where no one would suspect!",
        "viewed": False,
    },
}
...
def draw_map():
    ...
    if rooms["KITCHEN"]["viewed"] == True and rooms["GARDEN"]["viewed"] == True:
        layer3 = f"""
         _______________________      ______________________
        |                       |    |                      |
        |                       |    |                      |
        ...
        |_______________________|    |______________________|
        """
    elif rooms["KITCHEN"]["viewed"] == True and rooms["GARDEN"]["viewed"] == False:
        layer3 = f"""
         _______________________      ______________________
        |                       |    |                      |
        |                       |    |                      |
        ...
        |_______________________|    |______________________|
        """
    elif rooms["KITCHEN"]["viewed"] == False and rooms["GARDEN"]["viewed"] == True:
        layer3 = f"""
         _______________________      ______________________
        |                       |    |                      |
        |                       |    |                      |
